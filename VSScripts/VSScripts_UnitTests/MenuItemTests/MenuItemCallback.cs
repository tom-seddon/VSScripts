...
using Company.VSScripts;

namespace VSScripts_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSScriptsPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.VSScripts.GuidList.guidVSScriptsCmdSet, (int)Company.VSScripts.PkgCmdIDList.cmdidConfigureScripts);
